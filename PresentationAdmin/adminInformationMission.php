                                        ...
                                        <form id="frmInformation" method="POST" action="../BusinessAdmin/OrganizationAdminAction.php">
                                            <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                                ...
                                                <li role="presentation" class="">
                                                    <a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Mission</a>
                                                </li>
                                                <li role="presentation" class=""><input style="background: #ffffff;" type="submit" class="btn btn-large btn-block" value="Actualizar" onclick=" return validateFieldsMission()"/>
                                                </li>
                                            </ul>
                                            <div id="myTabContent" class="tab-content">
                                                <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                                                    <textarea id="txtMissionEs" name="txtMissionEs" class="form-control text-justify" rows="15" ><?php echo $result[0]; ?></textarea><label style="color: red;" id="txtErrorEs"></label>
                                                </div>
                                                <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
                                                    <textarea id="txtMissionEn" name="txtMissionEn"class="form-control text-justify" rows="15" ><?php echo $result[1]; ?></textarea><label style="color: red;" id="txtErrorEn"></label>
                                                </div>                                                        
                                            </div>
