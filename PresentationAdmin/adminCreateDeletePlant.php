                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <div class="bs-docs-section">
                                    <h1 id="glyphicons" class="page-header">Registrar planta</h1>
                                    <div class="" role="tabpanel" data-example-id="togglable-tabs">

                                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                            <li role="presentation" class="active">
                                                <a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Registar planta</a>
                                            </li> 
                                            <li role="presentation" class="">
                                                <a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Eliminar planta</a>
                                            </li>                                                                                              
                                        </ul>
                                        <div id="myTabContent" class="tab-content">
                                            ...
                                            <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
                                                <ul>
                                                    <?php
                                                    $plantB = new PlantAdminBusiness();
                                                    $result = $plantB->getAllPlants();
                                                    $plantEs = $result[0];
                                                    $maxEs = sizeof($plantEs);
                                                    for ($j = 0; $j < $maxEs; $j++) {
                                                        $currentPlantEs = $plantEs[$j];
                                                        ?>
                                                        <form id="frmDelete" method="POST" action="../BusinessAdmin/plantAdminAction.php" enctype="multipart/form-data">
                                                            <li><label style="width: 50%;"><?php echo $currentPlantEs->getScientificName(); ?></label><input type="submit" id="btnDelete" name="btnDelete" value="Eliminar"></li><br>
                                                            <input type="hidden" id="idPlant" name="idPlant" value="<?php echo $currentPlantEs->getIdPlant(); ?>" />
...
if (isset($_GET['successDelete'])) {
    ...
    echo '<script>                
            $(document).ready(function(){
                modalSelect("¡La planta se registró con éxito!","Registro");
                $("#myModal").modal("show");
            });
        </script>';
    ...
    echo '<script>                
            $(document).ready(function(){
                modalSelect("¡Error al registrar la planta!","Registro");
                $("#myModal").modal("show");
            });
        </script>';
