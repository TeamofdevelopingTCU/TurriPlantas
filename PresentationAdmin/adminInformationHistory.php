...
<html lang="en">
    <head>
        ...
        $result = $organization->getHistoryOrganization();
        ?>
    </head>
                                    ...
                                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                        <form id="frmInformation" method="POST" action="../BusinessAdmin/OrganizationAdminAction.php">
                                            <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                                ...
                                                <li role="presentation" class=""><input style="background: #ffffff;" type="submit" class="btn btn-large btn-block" value="Actualizar" onclick="return validateFieldsHistory();"/>
                                                </li>
                                            </ul>
                                            <div id="myTabContent" class="tab-content">
                                                <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                                                    <textarea id="txtHistoryEs" name="txtHistoryEs" class="form-control text-justify" rows="15" ><?php echo $result[0]; ?></textarea><label style="color: red;" id="txtErrorEs"></label>
                                                </div>
                                                <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
                                                    <textarea id="txtHistoryEn" name="txtHistoryEn"class="form-control text-justify" rows="15" ><?php echo $result[1]; ?></textarea><label style="color: red;" id="txtErrorEn"></label>
                                                </div>                                                        
                                            </div>
                                            <input type="hidden" id="option" name="option" value="history">
                                        </form>
                                    </div>
                                </div>
                            </div>
