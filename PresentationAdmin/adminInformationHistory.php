                                        ...
                                        <form id="frmInformation" method="POST" action="../BusinessAdmin/OrganizationAdminAction.php">
                                            ...
                                            <div id="myTabContent" class="tab-content">
                                                <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                                                    <textarea id="txtHistoryEs" name="txtHistoryEs" class="form-control text-justify" rows="15" ><?php echo $result[0]; ?></textarea>
                                                </div>
                                                <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
                                                    <textarea id="txtHistoryEn" name="txtHistoryEn"class="form-control text-justify" rows="15" ><?php echo $result[1]; ?></textarea>
                                                </div>                                                        
                                            </div>
