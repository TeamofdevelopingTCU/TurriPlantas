...
<body>
    ...
    <section id="services">
        <div class="container">
            ...
            <p class="text-justify">Turriplantas es una empresa familiar que inicia operaciones en el año 2003, produciendo y
                ...
                producción, manteniendo 2 Ha para protección y reforestación, del total de 8 Ha con que cuenta la empresa.
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="media-body">
                            ...
                            <p class="text-justify">Mantenernos como uno de los principales productores de plantas ornamentales de Costa Rica,
                                ...
                                producto. Con este concepto y la ayuda de Dios, cumpliremos nuestras metas.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="media-body">
                            ...
                            <p class="text-justify">Producir y exportar ornamentales de superior calidad a la existente en el Mercado. Llevar color y
                                ...
                                seguridad laboral. Manteniendo un ambiente de trabajo justo y agradable para nuestros colaboradores y sus familias.</p>
                        </div>
    ...
    <section id="testimonials">
        <div class="container">
            ...
            <div id="owl-testi" class="owl-carousel owl-theme">
                <div class="item">
                    <div class="quote">
                        <i class="fa fa-quote-left left fa-2x text-justify"></i>
                        <h5>Turriplantas se caracteriza por producir plantas de alta calidad, dando prioridad a la satisfacción de
                            ...
                            mezclan las plantas ornamentales con árboles maderables.<span></span>
                ...
                <div class="item">
                    <div class="quote">
                        ...
                        <h5>Además de la producción de plantas ornamentales, se cuenta con 34 variedades de árboles
                            ...
                            el abastecimiento de madera para la infraestructura necesaria dentro de la propia finca. <span>
                                
                            </span>.<i class="fa fa-quote-right right fa-2x"></i></h5>
                ...
                <div class="item">
                    <div class="quote">
                        ...
                        <h5>Se cuenta con una fuente de agua propia haciendo a Turriplantas un gran aliado y protector del
                            medio y se aporta a la zona con un paisaje hermoso.<span></span>
                            <i class="fa fa-quote-right right fa-2x"></i></h5>
	...
	============================================= -->
    <div>
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7860.749420061343!2d-83.62956042802038!3d9.902716471671553!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x3052cc28f4e6435c!2sTurriplantas+S.A.!5e0!3m2!1ses!2scr!4v1477779053501" width="100%" height="300" frameborder="0" style="border:0" allowfullscreen></iframe></div>
    <!-- Footer
	============================================= -->
    <footer>
        <div class="container">
